...
function setupHeroCarousel() {
    ...
    const carouselItems = [
        {
            image: './frontend/images/photo-1739606944848-97662c0430f0?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        ...
        {
            image: './frontend/images/photo-1645629022405-a3b40f0287e6.avif',
            title: 'Manali & Kashmir - ₹16,999',
            heading: 'Explore the Paradise',
            subheading: 'Experience the serene beauty of north India',
            tags: ['Mountains', 'Nature', 'Adventure']
...
function setupMenuAndUI() {
    ...
    menuContainer.innerHTML = `
        <div class="menu-section">
            ...
            <a href="./frontend/templates/aboutus.html" class="menu-item">About Us</a>
            <div class="menu-item has-submenu">
                <span>Our Services</span>
                <div class="submenu" style="display: none;">
                    <a href="./frontend/templates/Flight Tickets.html" class="submenu-item"><i class='bx bxs-plane-alt'></i> Flight Tickets</a>
                    <a href="./frontend/templates/Apply For Passport Application.html" class="submenu-item"><i class='bx bxs-id-card'></i> Apply For Passport Application</a>
                    <a href="./frontend/templates/visa for all countries.html" class="submenu-item"><i class='bx bxs-file-doc'></i> Visa For All Countries</a>
                    <a href="./frontend/templates/honeymoonpackages.html" class="submenu-item"><i class='bx bxs-heart'></i> Honeymoon Packages</a>
                    <a href="./frontenc/tamplates/forex.html" class="submenu-item"><i class='bx bx-money'></i> Forex Services</a>
                </div>
            </div>
            <div class="menu-item has-submenu">
                <span>Trips</span>
                <div class="submenu" style="display: none;">
                    <a href="./frontend/templates/Domestic Tours.html" class="submenu-item"><i class='bx bxs-map'></i> Domestic Tours</a>
                    <a href="./frontend/tamplates/International Tours.html" class="submenu-item"><i class='bx bx-globe'></i> International Tours</a>
                </div>
            </div>
            <a href="./frontend/templates/contactus.html" class="menu-item">Contact Us</a>
        </div>
    `;
    ...
    ourservicesmenu.innerHTML = `
        <div class="Section-ourservices">
            <a href="./frontend/templates/Flight Tickets.html">Flight Tickets</a>
            <a href="./frontend/templates/Apply For Passport Application.html">Apply For Passport Application</a>
            <a href="./frontend/templates/visa for all countries.html">Visa For All Countries</a>
            <a href="./frontend/templates/honeymoonpackages.html">Honeymoon Packages</a>
            <a href="./frontend/templates/forex.html">Forex Services</a>
        </div>
    `;
    ...
    tripsmenu.innerHTML = `
        <div class="Section-trips">
            <a href="./frontend/templates/Domestic Tours.html">Domestic Tours</a>
            <a href="./frontend/templates/International Tours.html">International Tours</a>
        </div>
    `;
